...
namespace OpenGL_Game.Systems
{
    ...
    {
        const ComponentTypes MASK = (ComponentTypes.COMPONENT_POSITION | ComponentTypes.COMPONENT_GEOMETRY | ComponentTypes.COMPONENT_CUBETEXTURE);
        ...
        public SystemSkyboxRender()
        {
            ...
            LoadShader("Shaders/vsky.glsl", ShaderType.VertexShader, pgmID, out vsID);
            LoadShader("Shaders/fsky.glsl", ShaderType.FragmentShader, pgmID, out fsID);
        ...
        public void OnAction(Entity entity)
        {
            if ((entity.Mask & MASK) == MASK)
            {
                ...
                {
                    return component.ComponentType == ComponentTypes.COMPONENT_CUBETEXTURE;
                });
                int texture = ((ComponentCubeTexture)textureComponent).Texture;
